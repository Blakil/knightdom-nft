    ...
    public partial class Form1 : Form
    {
            ...
            )
        {
            ...
            ts.Milliseconds / 10);
                ...
                //textBox1.AppendText("\r\n");
                using (StreamWriter writer = new StreamWriter(@"D:\Blender\NFT\JsonNFT\GenerationNFT\" + i + ".json"))
                {
                    writer.WriteLine("{");
                    writer.WriteLine("  \"project_name\": \"Knightdom\",");
                    writer.WriteLine("  \"symbol\": \"KDM\",");
                    writer.WriteLine("  \"description\": \"Unique collection of mysterous knights from Knightdom collection.\",");
                    writer.WriteLine("  \"seller_fee_basis_points\": 350,");
                    writer.WriteLine("  \"image\": \"image.png\",");
                    writer.WriteLine("  \"external_url\": \"https://www.artstation.com/blakil\",");
        ...
        public Form1()
        {
            ...
            Wallets.Add("14fyVx7zMzPMSkEeLDxcqXtTQWna7stTwrdgTNC7hXGc", 30);
